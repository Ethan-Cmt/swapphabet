...
public class random_getr {
    ...
    static List<String> data_fruits = Arrays.asList("ananas","avocat","pomme","poire","grenade","kiwi","datte","banane","cassis","cerise","citron","clémentine","fraise","framboise","cranberry","myrtille","kaki","litchi","abricot","figue","goyave","papaye","groseille","mandarine","mangue","melon","mûre","mirabelle","pastèque","olive","pêche","prune","raisin");
	...
	public static String getRandomWord(List<String> list)
    {
        ...
        if (random_word.length()>11){ // On rechoisi au hasard de manière récursive si le mot est trop long
